...
def store_diffs(args):
    ...
    np.save(f'train{args.suffix_file_diffs}', train_diffs)
    np.save(f'test{args.suffix_file_diffs}', test_diffs)


def load_diffs(args):
    train_diffs = np.load(f'train{args.suffix_file_diffs}',
                          allow_pickle=True)
    test_diffs = np.load(f'test{args.suffix_file_diffs}',
                         allow_pickle=True)
...
if __name__ == "__main__":
    ...
    args.suffix_file_diffs = f"_diffs_{args.model_type}_train_{args.dataset_train}_test_{args.dataset_test}.npy"
