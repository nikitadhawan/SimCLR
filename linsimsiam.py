...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == "cifar10":
        train_loader, val_loader = get_cifar10_data_loaders(download=False)#, batch_size=args.batch_size)
    elif args.dataset == "svhn":
        train_loader, val_loader = get_svhn_data_loaders(download=False)
    elif args.dataset == "stl10":
        train_loader, val_loader = get_stl10_data_loaders(download=False)
    else:
        train_loader, val_loader = get_imagenet_data_loaders(batch_size=args.batch_size)
